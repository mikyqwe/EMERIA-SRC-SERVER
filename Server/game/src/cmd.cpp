...
ACMD(do_inputall)
{
	ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT_LANGUAGE(ch->GetLanguage(),"명령어를 모두 입력하세요."));
}
...
#ifdef M2S_BIO_SYSTEM
	{ "bio_sys",				do_bio_mission,				0,	POS_DEAD,	GM_PLAYER },
#endif
...
//	{ "몬스터보여줘",	do_monsterlog,		0,			POS_DEAD,	GM_LOW_WIZARD	},//@fixme105
	...
	// END_OF_DANCE
	{ "hizlistatuver", do_hizlistatuver, 0, POS_DEAD, GM_PLAYER },
	...
	{ "qitem",	do_qitem,		0,		POS_DEAD,	GM_PLAYER	},
	{ "user_horse_back",	do_user_horse_back,		0,		POS_FISHING,	GM_PLAYER	},
	{ "user_horse_feed",	do_user_horse_feed,		0,		POS_FISHING,	GM_PLAYER	},
#ifdef ENABLE_AURA_SYSTEM
	{ "aura",	do_aura,		0,		POS_DEAD,	GM_PLAYER	},
#ifdef CLEAR_BONUS_AURA
	{ "do_clear_bonus_aura",	do_clear_bonus_aura,		0,		POS_DEAD,	GM_PLAYER	},
#endif
	{ "aura_gm",	do_aura_gm,		0,		POS_DEAD,	GM_IMPLEMENTOR	},
#endif
...
//	{ "주사위",				do_dice,				0,	POS_DEAD,	GM_PLAYER		},//@fixme105
	...
	{ "costume",			do_costume, 			0,	POS_DEAD,	GM_HIGH_WIZARD	},
#ifdef ENABLE_GUILD_ONLINE_LIST
	{ "guildlist",	do_guildlist,		0,		POS_DEAD,	GM_PLAYER },
#endif
...
#ifdef __ENABLE_TRASH_BIN__
	{ "trash_bin",				do_trash_bin,			0,		POS_DEAD,	GM_PLAYER		},
#endif
	{ "dragon_soul",				do_dragon_soul,				0,	POS_DEAD,	GM_PLAYER	},
	{ "ds_list",				do_ds_list,				0,	POS_DEAD,	GM_PLAYER	},
	{	"open_refine_ds",						do_open_refine_ds,					0,						POS_DEAD,			GM_PLAYER	},
	...
	{ "withdraw_offline_shop_cheque", do_withdraw_offline_shop_cheque, 0, POS_DEAD, GM_PLAYER },
	...
	{ "delete_item", do_test_edit_delete_item, 0, POS_DEAD, GM_PLAYER },
	{ "price_item", do_test_edit_price_item, 0, POS_DEAD, GM_PLAYER },
	{ "edit_shop_offline", do_test_edit_mode, 0, POS_DEAD, GM_PLAYER },
	{ "offline_add_item", do_test_put_item, 0, POS_DEAD, GM_PLAYER },
	{ "destroy_my_offline_shop", do_test_destroy_offline_shop, 0, POS_DEAD, GM_PLAYER },
	{ "close_edit_mode", do_close_edit_mode, 0, POS_DEAD, GM_PLAYER },
	{ "create_offline_shop_mode", do_create_offline_shop_mode, 0, POS_DEAD, GM_PLAYER },

#ifdef ENABLE_WOLFMAN_CHARACTER
	{ "bleeding",			do_bleeding,				0,			POS_DEAD,	GM_IMPLEMENTOR	},
#endif

	{ "capitale_teleport",			do_capitale_teleport,		0,	POS_DEAD,	GM_PLAYER	},
	{ "valle_teleport",				do_valle_teleport,			0,	POS_DEAD,	GM_PLAYER	},
	{ "covo_teleport",				do_covo_teleport,				0,	POS_DEAD,	GM_PLAYER	},
	{ "monte_teleport",				do_monte_teleport,				0,	POS_DEAD,	GM_PLAYER	},
	{ "grotta_teleport",			do_grotta_teleport,			0,	POS_DEAD,	GM_PLAYER	},
	{ "deserto_teleport",			do_deserto_teleport,			0,	POS_DEAD,	GM_PLAYER	},
	{ "capo_teleport",				do_capo_teleport,				0,	POS_DEAD,	GM_PLAYER	},
	{ "bosco_teleport",				do_bosco_teleport,				0,	POS_DEAD,	GM_PLAYER	},
	{ "fantasma_teleport",			do_fantasma_teleport,			0,	POS_DEAD,	GM_PLAYER	},
	{ "fuoco_teleport",				do_fuoco_teleport,				0,	POS_DEAD,	GM_PLAYER	},
	{ "baia_teleport",				do_baia_teleport,				0,	POS_DEAD,	GM_PLAYER	},
	{ "tonanti_teleport",			do_tonanti_teleport,			0,	POS_DEAD,	GM_PLAYER	},
	{ "torre_teleport",				do_torre_teleport,				0,	POS_DEAD,	GM_PLAYER	},
	{ "eruzione_teleport",			do_eruzione_teleport,			0,	POS_DEAD,	GM_PLAYER	},

#ifdef ENABLE_DECORUM
	{ "decorum_stat",				do_decorum_stat,			0,					POS_DEAD,	GM_PLAYER		},
	{ "decorum_block",				do_decorum_block,			0,					POS_DEAD,	GM_PLAYER		},
	{ "decorum_arena_accept",		do_decorum_arena_accept,	0,					POS_DEAD,	GM_PLAYER		},
	{ "decorum_season_force_end",	do_decorum_season_end,		0,					POS_DEAD,	GM_HIGH_WIZARD	},
	{ "set_decorum",				do_set_decorum,				0,					POS_DEAD,	GM_WIZARD		},
	{ "end_decorum_arena",			do_end_decorum_arena,		0,					POS_DEAD,	GM_HIGH_WIZARD	},
	{ "end_all_decorum_arena",		do_end_all_decorum_arena,	0,					POS_DEAD,	GM_HIGH_WIZARD	},
	{ "decorum_has_lobby",		do_decorum_has_lobby,	0,					POS_DEAD,	GM_PLAYER	},
#endif	
#ifdef __SPECIAL_STORAGE_SYSTEM__
	{ "sort_special_storage",	do_sort_special_storage,		0,			POS_DEAD,	GM_PLAYER		},
	{"storage_split_item",		do_storage_split_item,			0,			POS_DEAD,	GM_PLAYER		},
...
#endif
#ifdef __ENABLE_ITEM_GARBAGE__
	{ "disable_item_garbage", do_disable_item_garbage, 0, POS_DEAD, GM_IMPLEMENTOR },
	{ "item_garbage_log", do_item_garbage_log, 0, POS_DEAD, GM_IMPLEMENTOR },
#endif
#ifdef GUILD_WAR_COUNTER
...
#endif
	{ "mount_target",	do_mount_target,		0,		POS_DEAD,	GM_PLAYER },
#ifdef FAST_EQUIP_WORLDARD
...
void interpret_command(LPCHARACTER ch, const char * argument, size_t len)
{
	...
	if (ch->GetPosition() < cmd_info[icmd].minimum_position)
	{
		...
		{
			case POS_MOUNTING:
				ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT_LANGUAGE(ch->GetLanguage(),"탄 상태에서는 할 수 없습니다."));
				break;

			case POS_DEAD:
				ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT_LANGUAGE(ch->GetLanguage(),"쓰러진 상태에서는 할 수 없습니다."));
				break;

			case POS_SLEEPING:
				ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT_LANGUAGE(ch->GetLanguage(),"꿈속에서 어떻게요?"));
				break;

			case POS_RESTING:
			case POS_SITTING:
				ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT_LANGUAGE(ch->GetLanguage(),"먼저 일어 나세요."));
				break;
				/*
				   case POS_FIGHTING:
				   ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT_LANGUAGE(ch->GetLanguage(),"목숨을 걸고 전투 중 입니다. 집중 하세요."));
				   break;
				 */
			default:
	...
	{
		ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT_LANGUAGE(ch->GetLanguage(),"그런 명령어는 없습니다"));
		return;
	}

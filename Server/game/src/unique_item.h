#include "stdafx.h" //__ENABLE_TRASH_BIN__
...
enum
{
	...
	NEW_MOVE_SPEED_POTION = 20201,
	NEW_ATTACK_SPEED_POTION = 20202,
	NEW_KRITIK_POTION = 20203,
	NEW_DELICI_POTION = 20204,
	NEW_DRAGON_1_POTION = 20205,
	NEW_DRAGON_2_POTION = 20206,
	NEW_DRAGON_3_POTION = 20207,
	NEW_DRAGON_4_POTION = 20208,
	NEW_SEBNEM_PEMBE = 20209,
	NEW_SEBNEM_KIRMIZI = 20210,
	NEW_SEBNEM_MAVI = 20211,
	NEW_SEBNEM_BEYAZ = 20212,
	NEW_SEBNEM_YESIL = 20213,
	NEW_SEBNEM_SARI = 20214,
#endif
#ifdef __ENABLE_TRASH_BIN__
	TRASH_BIN_REWARD_ITEM_VNUM = 51001,
#endif
#ifdef ENABLE_DECORUM
	ITEM_NO_LOSS_DECORUM = 100784,
	ITEM_GAIN_DECORUM = 100785,
#endif
};

...
static DWORD RoulettePrice = 250000;
...
#else
	if (ch->CountSpecifyItem(RoulettePrice) < 1)
	{
		ch->ChatPacket(CHAT_TYPE_INFO, "You need the daily Ticket!");
		return;
	}
#endif
...
#else
	ch->RemoveSpecifyItem(RoulettePrice);
#endif
